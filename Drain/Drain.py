...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        for i, log_template in enumerate(log_templates):
            log_templates[i] = log_template.strip('"')
    ...
    def log_to_dataframe(self, log_file, regex, headers, logformat):
        ...
        log_messages = []
        linecount = 0
        with open(log_file, "r", encoding='utf-8' if self.logName != 'liberty.log' else 'ISO-8859-1') as fin:
